...
def ingest_uploaded_docs(attachment_paths: List[str]):
    ensure_collection()
    chunks = ingest_document(attachment_paths, output_dir="./temp_ingest")
    # logger.info(f"\nIngested {len(chunks)} chunks from {attachment_path}")
